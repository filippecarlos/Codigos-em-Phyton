...
class Pessoa:
	...
	def calcular_salario(self):
		percentual_adicional = self.emprego.bonus * len(self.dependentes)
		percentual_adicional = percentual_adicional/100
		salario_total = self.emprego.salario + (self.emprego.salario * percentual_adicional)
...
print("Salário: ", pessoa1.calcular_salario())   # imprime 1100.0