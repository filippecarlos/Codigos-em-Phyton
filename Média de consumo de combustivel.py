...
if qtd_metros <=10: #ok
    ...
    if(qtd_metros>11) and (qtd_metros<20): #ok
        print ("O valor a ser pago é: ", valor_fixo + 4.10) 
    else:
        if(qtd_metros >21) and (qtd_metros <30): # esse dá diferente
            print ("O valor a ser pago é: ", valor_fixo + 10,23 )
        else:
            if (qtd_metros >=31) and (qtd_metros <50):
                print ("O valor a ser pago é: ", valor_fixo + 10.23)#ok
            else:
                if (qtd_metros) >=50:
                    print ("O valor a ser pago é: ", valor_fixo + 11.27 ) #ok